    ...
    <div className="space-y-3">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <h3 className="heading-section">Quick Reply</h3>
      ...
      {items.length === 0 ? (
        <p className="py-4 text-center text-sm text-muted-foreground">ยังไม่มี Quick Reply — กดปุ่ม &ldquo;+ เพิ่ม&rdquo; เพื่อสร้าง</p>
      ) : (
